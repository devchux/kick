...
const StartTrivia = () => {
  ...
  return (
    <DashboardLayout className="md:pt-0">
      ...
      <div className="max-w-[67.4rem] mx-auto grid sm:grid-cols-2 md:grid-cols-4 gap-x-5 md:gap-x-0 gap-y-5 my-5">
      ...
      <div className="bg-white rounded-3xl overflow-hidden flex justify-between">
        <div className="py-5 px-5 md:pr-0 md:pl-7 md:max-w-48">
